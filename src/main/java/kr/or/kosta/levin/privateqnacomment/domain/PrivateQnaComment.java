...
public class PrivateQnaComment {
	...
	public boolean checkNull(PrivateQnaComment privateQnaComment) {
		...
		if(privateQnaComment.getEmail() == null || privateQnaComment.getCategory() == null || privateQnaComment.getContent() == null
				|| privateQnaComment.getEmail().trim().length() == 0 || privateQnaComment.getCategory().trim().length() == 0 
